...
// 	          data:$("#luruform").serialize(),
            success: function (data, textStatus, jqXHR) {
                if (data.status == 400) {
                    swal("请登入!");
                    window.location.href = "<%=path%>/userSave/goLogin";
                } else if (data.status == 500) {
                    swal("该用户非求职用户");
                    window.location.href = "<%=path%>/userSave/goMain";
                    ...
                    <div id="" class="" style="">
                        <form id="dpform">
                            <table width="100%" cellpadding="0" cellspacing="0" style=" margin-top: 10px;">
                                <input type="hidden" style="width:95%;height:35px;border: none; " name="empId"
                                       id="detail_empId">
                                <tr>
                                    <td width="91"><font class="c1"><a style="color:red ">*</a> 姓名：</font></td>
                                    <td width="237"><font class="c2"><input type="text"
                                                                            style="width:95%;height:35px;border: none; "
                                                                            name="realname" id="detail_realname"></font>
                                    </td>
                                    <td width="120"><font class="c1">性别：</font></td>
                                    <td width="289"><font class="c2"><select name="sex"
                                                                             style="width:95%;height:35px;border: none;"
                                                                             id="detail_sex">
                                    ...
                                    <td width="140" rowspan="4">
                                        <img id="detail_image" name="image" width="140px" height="160px" border=0
                                             onclick="change(); " src="<%=path%>/common/images/photoDefault.jpg"/>
                                        <input type="file" name="file" id="imageFile" onchange="previewImage(this);"
                                               style="display: none;"/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td><font class="c2"><select name="marry"
                                                                 style="width:95%;height:35px;border: none; "
                                                                 id="detail_marry">
                                        <option selected="selected" value="否">否</option>
                                        <option value="是">是</option></font></td>
                                </tr>
                                <tr>
                                    <td><font class="c1">国籍：</font></td>
                                    <td><font class="c2"><select name="country"
                                                                 style="width:95%;height:35px;border: none; "
                                                                 id="detail_country">
                                    ...
                                    <td><font class="c2"><select name="jobstatus"
                                                                 style="width:95%;height:35px;border: none; "
                                                                 id="detail_jobstatus">
                                        <option selected="selected"></option>
                                ...
                                <tr>
                                    ...
                                    <td><font class="c2"><input class="laydate-icon" type="text"
                                                                style="width:85%;height:35px;border: none; "
                                                                name="birthday" id="detail_birthday">
                                        <script>
                                            ;!function () {
                                                laydate({
                                ...
                                <tr>
                                    ...
                                    <td id="check3"><font class="c2"><input type="text"
                                                                            style="width:95%;height:35px;border: none; "
                                                                            name="qq" id="detail_qq"
                                                                            onblur="checkData(this.value)"></font></td>

                                </tr>
                                <tr>
                                    <td><font class="c1">邮箱地址：</font></td>
                                    <td id="check1"><font class="c2"><input type="text"
                                                                            style="width:95%;height:35px;border: none; "
                                                                            name="email" id="detail_email"></font></td>
                                    <td><font class="c1 ">电话号码：</font></td>
                                    <td id="check2" colspan="2"><font class="c2"><input type="text"
                                                                                        style="width:95%;height:35px;border: none;"
                                                                                        name="tel" id="detail_tel"
                                                                                        onblur="isMobile(this.value)"></font>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2"><font class="c2"><input type="text"
                                                                            style="padding-left:2%;width:95%;height:35px;border: none; "
                                                                            name="address" id="detail_address"></font>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" align="center">
                                <tr>
                                    ...
                                    <td width="568"><font class="c2"><input type="text"
                                                                            style="padding-left:2%; width:95%;height:35px;border: none;  "
                                                                            name="description" id="detail_description"></font>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><font class="c2"><input type="text"
                                                                style="padding-left:2%; width:95%;height:38px;border: none; "
                                                                name="work" id="detail_work"></font></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><font class="c2"><input type="text"
                                                                style="padding-left:2%; width:95%;height:38px;border: none; "
                                                                name="experience" id="detail_experience"></font></td>
                                </tr>
                            </table>
                        </form>
