...
// 	});
            $.formValidator.initConfig({
                formID: "userform", debug: false, submitOnce: true,
                onError: function (msg, obj, errorlist) {
                    $("#errorlist").empty();
                    $.map(errorlist, function (msg) {
                        $("#errorlist").append("<li>" + msg + "</li>")
            ...
            $("#username").formValidator({
                ...
                onCorrect: "该用户名可以注册"
            }).inputValidator({min: 5, max: 10, onError: "你输入的用户名非法,请确认"})//.regexValidator({regExp:"username",dataType:"enum",onError:"用户名格式不正确"})
                .ajaxValidator({
                    dataType: "text",
                    async: true,
                    url: "<%=path%>/userSave/checkUsername",
                    ...
                    <section class="col-lg-9 col-md-9 col-sm-9">
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 m_xs_bottom_30">
                                ...
                                <ul id="errorlist"></ul>
                                <form id="userform" action="<%=path%>/userSave/saveUser">
                                    <ul>
                                        <li class="clearfix m_bottom_15">
                                            <div class="f_left half_column">
                                                <label for="username" class="required d_inline_b m_bottom_5">用户名:</label>
                                        ...
                                        <li class="m_bottom_15">
                                            <label for="password1" class="d_inline_b m_bottom_5">密码:</label>
                                        ...
                                        <li class="m_bottom_15">
                                            <label for="password2" class="d_inline_b m_bottom_5">确认密码:</label>
                                            <input type="password" id="password2" name="password"
                                                   class="full_width r_corners">
                                            <div id="password2Tip" style="width:250px"></div>
                                        </li>
                                        <li class="m_bottom_15">
                                            <label for="status" class="d_inline_b m_bottom_5 required">用户类型</label>
                                            <select name="type" id="status">
                                                <option value="0" selected="selected">求职用户</option>
