...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $(function () {
                $("#username").val("${sessionScope.user.account}");
            })
        ...
        function updateUser() {
            if ($('#username').val() != "${sessionScope.user.account}") {
                swal("用户输入无效!");
                return;
            }
            if ("${sessionScope.user.pass}" != $('#oldpwd').val()) {
                swal("旧密码错误!");
                return;
            }
            $("#id").val(${sessionScope.user.id});
            $.ajax({
                url: "<%=path%>/userSave/updateUserInfo",
                type: "post",
                dataType: "json",
                data: {
                                    ...
                                    <ul>
                                        <li class="clearfix m_bottom_15">
                                            <div class="f_left half_column">
                                                <label for="username"
                                                       class="required d_inline_b m_bottom_5">用户名:</label>
                                        ...
                                        <li class="m_bottom_15">
                                            <label for="password1" class="d_inline_b m_bottom_5">新密码:</label>
                                        ...
                                        <li class="m_bottom_15">
                                            <label for="password2" class="d_inline_b m_bottom_5">重复密码:</label>
                                        ...
                                        <li class="m_bottom_15">
                                            <button class="button_type_4 bg_light_color_2 r_corners mw_0 tr_all_hover color_dark"
                                                    type="button" onclick="updateUser();">保存
                                            </button>
                                        </li>
                                    </ul>
                                </form>
