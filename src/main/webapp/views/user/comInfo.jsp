    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.formValidator.initConfig({
                formID: "comform", debug: false, submitOnce: true,
            ...
            $("#fullname").formValidator({
                onShow: "请输入用户名,",
                onFocus: "用户名至少5个字符,最多30个字符",
                onCorrect: "该用户名可以注册"
            }).inputValidator({min: 5, max: 30, onError: "你输入的用户名非法,请确认"})//.regexValidator({regExp:"username",dataType:"enum",onError:"用户名格式不正确"})
                .ajaxValidator({
                    dataType: "text",
                    async: true,
                                    ...
                                    <ul>
                                        ...
                                        <li class="m_bottom_15">
                                            <button class="button_type_4 bg_light_color_2 r_corners mw_0 tr_all_hover color_dark"
                                                    type="button" onclick="updateCom();">保存
                                            </button>
                                        </li>
                                    </ul>
                                </form>
