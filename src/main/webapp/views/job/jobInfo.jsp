                    ...
                    <section class="col-lg-9 col-md-9 col-sm-9">
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 m_xs_bottom_30">
                                ...
                                <ul id="errorlist"></ul>
                                <form id="jobform">
                                    <input type="hidden" id="jobId" name="jobId" class="full_width r_corners"
                                           value="${job.jobId}" readonly="true">
                                    <input type="hidden" id="comId" name="comId" class="full_width r_corners"
                                           value="${job.comId}" readonly="true">
                                    <ul>
                                        <li class="clearfix m_bottom_15">
                                            <div class="f_left half_column">
                                                <label for="jobName"
                                                       class="required d_inline_b m_bottom_5">职位名称:</label>
                                                <input type="text" id="jobName" name="jobName"
                                                       class="full_width r_corners" value="${job.jobName}"
                                                       readonly="true">
                                            </div>
                                        </li>
                                        <li class="m_bottom_15">
                                            <label for="cf_message" class="d_inline_b m_bottom_5 required">工作类型</label>
                                            <input type="text" id="jobStatus" name="jobStatus"
                                                   class="full_width r_corners" value="${job.jobStatus}"
                                                   readonly="true">
                                        </li>
                                        <li class="m_bottom_15">
                                            <label for="jobPersoncount" class="d_inline_b m_bottom_5">招聘(人数):</label>
                                            <input type="text" id="jobPersoncount" name="jobPersoncount"
                                                   class="full_width r_corners" value="1" value="${job.jobPersoncount}"
                                                   readonly="true">
                                        </li>
                                        <li class="m_bottom_15">
                                            <label for="description" class="d_inline_b m_bottom_5 required">岗位介绍</label>
                                            <input id="description" type="text" name="description"
                                                   class="full_width r_corners" value="${job.description}"
                                                   readonly="true"></input>
                                        ...
                                        <li class="m_bottom_15">
                                            ...
                                            <input type="text" id="salary" name="salary" class="full_width r_corners"
                                                   value="${job.salary}" readonly="true">
                                        ...
                                        <li class="m_bottom_15">
                                            ...
                                            <input type="text" id="endDate" name="endDate" class="full_width r_corners"
                                                   value="${job.endDate}" readonly="true">
                                        ...
                                        <ul>
                                            <li class="clearfix m_bottom_15">
                                                <div class="f_left half_column">
                                                    <label for="fullname"
                                                           class="required d_inline_b m_bottom_5">公司名称:</label>
                                                    <input type="text" id="fullname" name="fullname"
                                                           class="full_width r_corners" value="${job.fullname}"
                                                           readonly="true">
                                            ...
                                            <li class="m_bottom_15">
                                                <label for="cf_message"
                                                       class="d_inline_b m_bottom_5 required">公司类型</label>
                                                <input type="text" id="comtype" name="comtype"
                                                       class="full_width r_corners" value="${job.comtype}"
                                                       readonly="true">
                                            ...
                                            <li class="m_bottom_15">
                                                ...
                                                <input type="text" id="empcount" name="empcount"
                                                       class="full_width r_corners" value="${job.empcount}"
                                                       readonly="true">
                                                <div id="empcountTip" style="width:250px">
                                            </li>
                                            <li class="m_bottom_15">
                                                <label for="description"
                                                       class="d_inline_b m_bottom_5 required">公司介绍</label>
                                                <input type="text" id="description" name="description"
                                                       class="full_width r_corners" value="${job.comDescription}"
                                                       readonly="true"></input>
                                                <div id="descriptionTip" style="width:250px">
                                            </li>
                                            <li class="m_bottom_15">
                                                ...
                                                <input type="text" id="address" name="address"
                                                       class="full_width r_corners" value="${job.comAddress}"
                                                       readonly="true">
