                            ...
                            <section class="col-lg-9 col-md-9 col-sm-9">
                                ...
                                <article class="m_bottom_25">
                                    ...
                                    <div class="row clearfix m_bottom_10">
                                        <div class="col-lg-9 col-md-9 col-sm-9">
                                            <h4 class="m_bottom_5"><a href="#" class="color_dark fw_medium">人力资源总监揭秘：面试时我的想法</a>
                                            </h4>
                                            <p class="f_size_medium">2017-05-06 <a href="#" class="color_dark"></a>, <a
                                                    href="#" class="color_dark">曹先生</a></p>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3 t_align_r t_sm_align_l">
                                            ...
                                            <a href="#" class="d_inline_middle f_size_medium default_t_color m_left_5">(1
                                                Vote)</a>
                                        </div>
                                    </div>
                                    <!--post content-->
                                ...
                                <article class="m_bottom_20 clearfix">
                                    ...
                                    <div class="mini_post_content">
                                        <h4 class="m_bottom_5"><a href="#" class="color_dark fw_medium">自信比专业更重要</a>
                                        </h4>
                                        <p class="f_size_medium m_bottom_10">2017-05-07, <a href="#"
                                                                                            class="color_dark"></a> <a
                                                href="#" class="color_dark">诸先生</a></p>
                                        <hr>
                                        <div class="rating_min_article">
                                            <p class="f_size_medium d_inline_middle d_sm_block d_xs_inline_middle">
                                                职场</p>
                                            <!--rating-->
                                            ...
                                            <a href="#" class="d_inline_middle f_size_medium default_t_color m_left_5">(3
                                                Votes)</a>
                                        </div>
                                        <hr class="m_bottom_15">
                                        <p class="m_bottom_10">
                                            你喜欢自信。事实上，我们中的大多数人偏爱自信，更甚于真实的专业技能。抢先发言、自信的表达、经常发表看法等行为让你听起来就像一个领导者，而能够做到这些的人大多数也成为了真正的领导者——即使他们其实不知道自己在讲些什么。
                                ...
                                <article class="m_bottom_20 clearfix">
                                    ...
                                    <div class="mini_post_content">
                                        <h4 class="m_bottom_5"><a href="#" class="color_dark fw_medium">就业季必看的职业规划</a>
                                        </h4>
                                        <p class="f_size_medium m_bottom_10">2017-05-08, <a href="#"
                                                                                            class="color_dark"></a><a
                                                href="#" class="color_dark">孙先生</a></p>
                                        <hr>
                                        <div class="rating_min_article">
                                            <p class="f_size_medium d_inline_middle d_sm_block d_xs_inline_middle">
                                                毕业生</p>
                                            ...
                                            <a href="#" class="d_inline_middle f_size_medium default_t_color m_left_5">(0
                                                Vote)</a>
                                        </div>
                                        <hr class="m_bottom_15">
                                        <p class="m_bottom_10">
                                ...
                                <article class="m_bottom_20 clearfix">
                                    ...
                                    <div class="mini_post_content">
                                        <h4 class="m_bottom_5"><a href="#" class="color_dark fw_medium">9招教你跟HR谈薪酬</a>
                                        </h4>
                                        <p class="f_size_medium m_bottom_10">2017-04-20, <a href="#"
                                                                                            class="color_dark"></a>, <a
                                                href="#" class="color_dark">刘备</a></p>
                                        <hr>
                                        <div class="rating_min_article">
                                            <p class="f_size_medium d_inline_middle d_sm_block d_xs_inline_middle">
                                                职场</p>
                                            ...
                                            <a href="#" class="d_inline_middle f_size_medium default_t_color m_left_5">(12
                                                Votes)</a>
                                        </div>
                                        <hr class="m_bottom_15">
                                        <p class="m_bottom_10">
                                            9招教你跟HR谈薪酬：①准确自估身价；②恰当展现“不可替代”的自己；③把握问薪时机；④敢于提出合理要求；⑤说薪金范围，不说具体数值；⑥巧妙咨询发问；⑦小心“税收陷阱”；⑧争取“额外”工资；⑨遇阻时采取迂回战术进行协商。
                                ...
                                <article class="m_bottom_20 clearfix">
                                    ...
                                    <div class="mini_post_content">
                                        <h4 class="m_bottom_5"><a href="#"
                                                                  class="color_dark fw_medium">为什么你得不到工作机会？ </a></h4>
                                        <p class="f_size_medium m_bottom_10">2017-04-19, <a href="#"
                                                                                            class="color_dark"></a> <a
                                                href="#" class="color_dark">宋仲基</a></p>
                                        <hr>
                                        <div class="rating_min_article">
                                            <p class="f_size_medium d_inline_middle d_sm_block d_xs_inline_middle">
                                                职场</p>
                                            ...
                                            <a href="#" class="d_inline_middle f_size_medium default_t_color m_left_5">(7
                                                Votes)</a>
                                        </div>
                                        <hr class="m_bottom_15">
                                        <p class="m_bottom_10">
