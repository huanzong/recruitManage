...
<script type="text/javascript">
    $(function () {
        cols = [
            ...
            {field: 'postion', title: '地点', width: 180, sortable: true},
            {field: 'startTime', title: '开始时间', width: 80, sortable: true},
            {field: 'endTime', title: '结束时间', width: 80, sortable: true},
            {field: 'companyCount', title: '公司规模', width: 80, sortable: true},
        ...
        datagridInit("/jobFair/index", cols);
    });

    function openAdd() {
        openDialog("新增", "jobFairEdit.jsp", 550, 400, add);
    }

    function openEdit() {
        openDialog("修改", "jobFairEdit.jsp", 550, 400, edit, $('#tt').datagrid('getSelected'));
    }
