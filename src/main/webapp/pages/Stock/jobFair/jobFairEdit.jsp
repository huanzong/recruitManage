...
<form id="wu-form-2" method="post">
    <div style="padding: 10px 15px 10px 15px">
        <table>
            ...
            <tr>
                <td align="right" class="wu-form-text"> 地点：</td>
                <td colspan="3"><input type="text" name="postion" style="width: 460px"
                                       class="easyui-validatebox inputlist comments" required="true"></td>
            </tr>
            <tr>
                <td align="right" class="wu-form-text">开始时间：</td>
                <td><input type="text" name="startTime" class="easyui-datebox wu-text inputlist" required="required">
                </td>
                <td align="right" class="wu-form-text">结束时间：</td>
                <td><input type="text" name="endTime" class="easyui-datebox wu-text inputlist" required="true">
                </td>
            </tr>
            <tr>
                <td align="right" class="wu-form-text"> 公司规模：</td>
                <td colspan="3"><input type="text" name="companyCount" style="width: 460px"
                                       class="easyui-validatebox inputlist comments" required="true"></td>
            </tr>
            <tr>
                <td align="right" class="wu-form-text"> 备注：</td>
                <td colspan="3"><input type="text" name="comment" style="width: 460px"
                                       class="easyui-validatebox inputlist comments" required="true"></td>
            </tr>
        </table>
    </div>
