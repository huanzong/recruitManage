...
<script type="text/javascript">
    $(function () {
        cols = [
            ...
            {field: 'hotname', title: '是否热门', width: 80, sortable: true},
        ...
        datagridInit("/jobskill/index", cols);
    });

    function openAdd() {
        openDialog("新增", "jobskillEdit.jsp", 550, 400, add);
    }

    function openEdit() {
        openDialog("修改", "jobskillEdit.jsp", 550, 400, edit, $('#tt').datagrid('getSelected'));
    }
