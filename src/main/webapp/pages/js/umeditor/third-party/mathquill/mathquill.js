...
var Parser = P(function(_, _super, Parser) {
  ...
  // construct your Parser from the Abase parsers and the
...
/**
 * MathQuill virtual-DOM tree-node abstract Abase class
 */
...
/**
 * Math tree fragment Abase class.
